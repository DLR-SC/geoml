...
//
    ...
    GEOML_EXPORT MakeLoops(const TopoDS_Shape& theNetWork,
    ...
    GEOML_EXPORT   void Init(const TopoDS_Shape& theNetWork,
                            const TopTools_MapOfShape& GuidesEdges,
                            const TopTools_MapOfShape& ProfileEdges);
     ...
     */
    GEOML_EXPORT  const Handle(TopTools_HArray2OfShape)& Cells() const;
     ...
     */
    GEOML_EXPORT  const NCollection_DataMap<TopoDS_Shape, geoml::Continuity>& Continuities() const;
    ...
    GEOML_EXPORT Standard_Integer GetStatus() const;
...
//
    ...
    NCollection_DataMap<TopoDS_Shape, geoml::Continuity> myContinuities;
