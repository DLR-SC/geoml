...
#ifndef INTERPOLATEWIRES_H
#define INTERPOLATEWIRES_H
...
/**
 * @brief The InterpolateWires class is used to create loft topologies using cross sections
 ...
 * InterpolateWires::setMakeSolid(false)
 */
...
public:
     ...
     */
    GEOML_EXPORT void addWire(const TopoDS_Shape& profiles);
     ...
     */
    GEOML_EXPORT void addGuides(const TopoDS_Shape& guides);
     ...
     */
    GEOML_EXPORT void setMakeSolid(bool enabled);
     ...
     */
    GEOML_EXPORT void setMakeSmooth(bool enabled);
    
    GEOML_EXPORT TopoDS_Shape& Shape();
    
    GEOML_EXPORT operator TopoDS_Shape& ();
...
private:
     ...
     * transform it to a shell otherwise (wrapper for PatchShellTool)
     */
    void CloseShape();
