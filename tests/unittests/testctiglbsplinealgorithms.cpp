...
TEST(BSplineAlgorithms, testComputeParamsBSplineCurve)
{
    ...
    ASSERT_NEAR(getPrimal(parameters[0]), getPrimal(right_parameters(1)), 1e-15);
    ASSERT_NEAR(getPrimal(parameters[1]), getPrimal(right_parameters(2)), 1e-15);
    ASSERT_NEAR(getPrimal(parameters[2]), getPrimal(right_parameters(3)), 1e-15);
    ASSERT_NEAR(getPrimal(parameters[3]), getPrimal(right_parameters(4)), 1e-15);
}
...
TEST(BSplineAlgorithms, testCreateCommonKnotsVectorCurve)
{
    ...
    ASSERT_NEAR(getPrimal(right_knot_vector(1)), getPrimal(computed_knot_vector(1)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(2)), getPrimal(computed_knot_vector(2)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(3)), getPrimal(computed_knot_vector(3)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(4)), getPrimal(computed_knot_vector(4)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(5)), getPrimal(computed_knot_vector(5)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(6)), getPrimal(computed_knot_vector(6)), 1e-15);
    ASSERT_NEAR(getPrimal(right_knot_vector(7)), getPrimal(computed_knot_vector(7)), 1e-15);
}
...
TEST(BSplineAlgorithms, testCreateCommonKnotsVectorTolerance)
{
    ...
    EXPECT_NEAR(0.009, getPrimal(curves[0]->Knot(1)), 1e-10);
    EXPECT_NEAR(0.500, getPrimal(curves[0]->Knot(2)), 1e-10);
    EXPECT_NEAR(0.800, getPrimal(curves[0]->Knot(3)), 1e-10);
    EXPECT_NEAR(1.000, getPrimal(curves[0]->Knot(4)), 1e-10);
    ...
    EXPECT_NEAR(0.000, getPrimal(curves[1]->Knot(1)), 1e-10);
    EXPECT_NEAR(0.491, getPrimal(curves[1]->Knot(2)), 1e-10);
    EXPECT_NEAR(0.800, getPrimal(curves[1]->Knot(3)), 1e-10);
    EXPECT_NEAR(1.000, getPrimal(curves[1]->Knot(4)), 1e-10);
...
TEST(BSplineAlgorithms, testCreateCommonKnotsVectorToleranceBug)
{
    ...
    EXPECT_NEAR(0.00, getPrimal(curves[0]->Knot(1)), 1e-10);
    EXPECT_NEAR(0.49, getPrimal(curves[0]->Knot(2)), 1e-10);
    EXPECT_NEAR(0.61, getPrimal(curves[0]->Knot(3)), 1e-10);
    EXPECT_NEAR(1.00, getPrimal(curves[0]->Knot(4)), 1e-10);
    ...
    EXPECT_NEAR(0.00, getPrimal(curves[1]->Knot(1)), 1e-10);
    EXPECT_NEAR(0.49, getPrimal(curves[1]->Knot(2)), 1e-10);
    EXPECT_NEAR(0.57, getPrimal(curves[1]->Knot(3)), 1e-10);
    EXPECT_NEAR(1.00, getPrimal(curves[1]->Knot(4)), 1e-10);
...
TEST(BSplineAlgorithms, testCreateCommonKnotsVectorSurface)
{
    ...
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(1)), getPrimal(right_knot_vector_u(1)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(2)), getPrimal(right_knot_vector_u(2)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(3)), getPrimal(right_knot_vector_u(3)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(4)), getPrimal(right_knot_vector_u(4)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(5)), getPrimal(right_knot_vector_u(5)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_u(6)), getPrimal(right_knot_vector_u(6)), 1e-15);
    ...
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(1)), getPrimal(right_knot_vector_v(1)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(2)), getPrimal(right_knot_vector_v(2)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(3)), getPrimal(right_knot_vector_v(3)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(4)), getPrimal(right_knot_vector_v(4)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(5)), getPrimal(right_knot_vector_v(5)), 1e-15);
    ASSERT_NEAR(getPrimal(computed_knot_vector_v(6)), getPrimal(right_knot_vector_v(6)), 1e-15);
...
TEST(BSplineAlgorithms, testReparametrizeBSplineContinuouslyApprox)
{
    ...
    for (size_t param_idx = 0; param_idx < old_parameters.size(); ++param_idx) {
        ...
        ASSERT_NEAR(getPrimal(old_point.X()), getPrimal(new_point.X()), 1e-10);
        ASSERT_NEAR(getPrimal(old_point.Y()), getPrimal(new_point.Y()), 1e-10);
        ASSERT_NEAR(getPrimal(old_point.Z()), getPrimal(new_point.Z()), 1e-10);
    }
}
...
TEST(BSplineAlgorithms, testReparametrizeBSplineContinuouslyApproxWithKink)
{
    ...
    EXPECT_NEAR(0.6, getPrimal(splineRepar->Knot(3)), 1e-10);
...
TEST(BSplineAlgorithms, reparametrizeBSpline)
{
    ...
    ASSERT_NEAR(getPrimal(spline->FirstParameter()), -5, 1e-10);
    ASSERT_NEAR(getPrimal(spline->LastParameter()),  5, 1e-10);
}
...
TEST(BSplineAlgorithms, reparametrizeBSplineNiceKnots)
{
    ...
    for (auto nPoints : pointCountVec) {
        for (bool make_close : {false, true}) {
            ...
            EXPECT_TRUE(fabs(fmod(log2(getPrimal(knotdist)), 1)) < 1e-4);
        }
    }
}
...
TEST(BSplineAlgorithms, testFlipSurface)
{
    ...
    for (int u_idx = 0; u_idx < 101; ++u_idx) {
        for (int v_idx = 0; v_idx < 101; ++v_idx) {
            ...
            ASSERT_NEAR(getPrimal(point.X()), getPrimal(same_point.X()), 1e-15);
            ASSERT_NEAR(getPrimal(point.Y()), getPrimal(same_point.Y()), 1e-15);
            ASSERT_NEAR(getPrimal(point.Z()), getPrimal(same_point.Z()), 1e-15);
        }
    }
}
...
TEST(BSplineAlgorithms, testInterpolatingSurface)
{
    ...
    for (unsigned int u_idx = 1; u_idx <= 100; ++u_idx) {
        for (unsigned int v_idx = 1; v_idx <= 100; ++v_idx) {
            ...
            ASSERT_NEAR(getPrimal(interp_pnt.X()), getPrimal(surf_pnt.X()), 4e-15);
            ASSERT_NEAR(getPrimal(interp_pnt.Y()), getPrimal(surf_pnt.Y()), 4e-15);
            ASSERT_NEAR(getPrimal(interp_pnt.Z()), getPrimal(surf_pnt.Z()), 4e-15);
        }
    }
}
...
TEST(BSplineAlgorithms, testCreateGordonSurface)
{
    ...
    for (int u_idx = 0; u_idx <= 100; ++u_idx) {
        for (int v_idx = 0; v_idx <= 100; ++v_idx) {
            ...
            ASSERT_NEAR(getPrimal(surface_point.X()), getPrimal(right_point.X()), getPrimal(tolerance));
            ASSERT_NEAR(getPrimal(surface_point.Y()), getPrimal(right_point.Y()), getPrimal(tolerance));
            ASSERT_NEAR(getPrimal(surface_point.Z()), getPrimal(right_point.Z()), getPrimal(tolerance));
        }
    }
...
TEST(BSplineAlgorithms, testIntersectionFinder)
{
    ...
    ASSERT_NEAR(getPrimal(intersection_vector[0].first), 0.5 + std::sqrt(0.1), 1e-13);
    ASSERT_NEAR(getPrimal(intersection_vector[0].second), 4. / 5, 1e-13);
}
/*
...
TEST(BSplineAlgorithms, testCreateGordonSurfaceGeneral)
{
    ...
    for (int u_idx = 0; u_idx <= 100; ++u_idx) {
        for (int v_idx = 0; v_idx <= 100; ++v_idx) {
            ...
            ASSERT_NEAR(getPrimal(surface_point.X()), getPrimal(right_point.X()), 1e-13);
            ASSERT_NEAR(getPrimal(surface_point.Y()), getPrimal(right_point.Y()), 1e-13);
            ASSERT_NEAR(getPrimal(surface_point.Z()), getPrimal(right_point.Z()), 1e-13);
        }
    }
}
...
TEST(BSplineAlgorithms, testIntersection_Bug783_1)
{
    ...
    EXPECT_NEAR(0.25, getPrimal(result.front().first), 1e-6);
    EXPECT_NEAR(0.215758, getPrimal(result.front().second), 1e-6);
}
...
TEST(BSplineAlgorithms, testIntersection_Bug783_2)
{
    ...
    // Result from OCCT 6.9.x
    EXPECT_NEAR(0.25, getPrimal(result.front().first), 1e-6);
    EXPECT_NEAR(0.0, getPrimal(result.front().second), 1e-6);
}
...
TEST(BSplineAlgorithms, findKinks)
{
    ...
    EXPECT_NEAR(0.7, getPrimal(kinks[0]), 1e-10);
...
TEST(BSplineAlgorithms, knotsFromParams)
{
    ...
    EXPECT_NEAR(0., getPrimal(knots[0]), 1e-10);
    EXPECT_NEAR(0., getPrimal(knots[1]), 1e-10);
    EXPECT_NEAR(0., getPrimal(knots[2]), 1e-10);
    EXPECT_NEAR(0.375, getPrimal(knots[3]), 1e-10);
    EXPECT_NEAR(0.625, getPrimal(knots[4]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[5]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[6]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[7]), 1e-10);
    ...
    EXPECT_NEAR(0., getPrimal(knots[1]), 1e-10);
    EXPECT_NEAR(0., getPrimal(knots[2]), 1e-10);
    EXPECT_NEAR(0., getPrimal(knots[3]), 1e-10);
    EXPECT_NEAR(0.5, getPrimal(knots[4]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[5]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[6]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[7]), 1e-10);
    EXPECT_NEAR(1., getPrimal(knots[8]), 1e-10);
...
TEST(BSplineAlgorithms, knotsFromParamsClosed)
{
    ...
    EXPECT_NEAR(-0.1875, getPrimal(knots[0]), 1e-10);
    EXPECT_NEAR(-0.125, getPrimal(knots[1]), 1e-10);
    EXPECT_NEAR(-0.0625, getPrimal(knots[2]), 1e-10);
    EXPECT_NEAR(0.0, getPrimal(knots[3]), 1e-10);
    EXPECT_NEAR(0.0625, getPrimal(knots[4]), 1e-10);
    EXPECT_NEAR(0.125, getPrimal(knots[5]), 1e-10);
    EXPECT_NEAR(0.1875, getPrimal(knots[6]), 1e-10);
    EXPECT_NEAR(0.25, getPrimal(knots[7]), 1e-10);
    EXPECT_NEAR(0.3125, getPrimal(knots[8]), 1e-10);
    EXPECT_NEAR(0.375, getPrimal(knots[9]), 1e-10);
    EXPECT_NEAR(0.5625, getPrimal(knots[10]), 1e-10);
    EXPECT_NEAR(0.625, getPrimal(knots[11]), 1e-10);
    EXPECT_NEAR(0.8125, getPrimal(knots[12]), 1e-10);
    EXPECT_NEAR(0.875, getPrimal(knots[13]), 1e-10);
    EXPECT_NEAR(0.9375, getPrimal(knots[14]), 1e-10);
    EXPECT_NEAR(1.0, getPrimal(knots[15]), 1e-10);
    EXPECT_NEAR(1.0625, getPrimal(knots[16]), 1e-10);
    EXPECT_NEAR(1.125, getPrimal(knots[17]), 1e-10);
    EXPECT_NEAR(1.1875, getPrimal(knots[18]), 1e-10);

    degree = 2;
    knots = geoml::BSplineAlgorithms::knotsFromCurveParameters(params, degree, true);
    ASSERT_EQ(17, knots.size());
    EXPECT_NEAR(-0.125, getPrimal(knots[0]), 1e-10);
    EXPECT_NEAR(-0.0625, getPrimal(knots[1]), 1e-10);
    EXPECT_NEAR(0., getPrimal(knots[2]), 1e-10);
    EXPECT_NEAR(0.0625, getPrimal(knots[3]), 1e-10);
    EXPECT_NEAR(0.125, getPrimal(knots[4]), 1e-10);
    EXPECT_NEAR(0.1875, getPrimal(knots[5]), 1e-10);
    EXPECT_NEAR(0.25, getPrimal(knots[6]), 1e-10);
    EXPECT_NEAR(0.3125, getPrimal(knots[7]), 1e-10);
    EXPECT_NEAR(0.375, getPrimal(knots[8]), 1e-10);
    EXPECT_NEAR(0.5, getPrimal(knots[9]), 1e-10);
    EXPECT_NEAR(0.625, getPrimal(knots[10]), 1e-10);
    EXPECT_NEAR(0.75, getPrimal(knots[11]), 1e-10);
    EXPECT_NEAR(0.875, getPrimal(knots[12]), 1e-10);
    EXPECT_NEAR(0.9375, getPrimal(knots[13]), 1e-10);
    EXPECT_NEAR(1.0, getPrimal(knots[14]), 1e-10);
    EXPECT_NEAR(1.0625, getPrimal(knots[15]), 1e-10);
    EXPECT_NEAR(1.125, getPrimal(knots[16]), 1e-10);
}
...
TEST(BSplineAlgorithms, trimSurfaceBug)
{
    ...
    EXPECT_NEAR(0., getPrimal(u1), 1e-10);
    EXPECT_NEAR(1., getPrimal(u2), 1e-10);
    EXPECT_NEAR(0.5, getPrimal(v1), 1e-10);
    EXPECT_NEAR(0.666666666666666666, getPrimal(v2), 1e-10);
...
TEST_F(TestConcatSurfaces, concatUDir)
{
    ...
    EXPECT_NEAR(0.0, getPrimal(u1), 1e-15);
    EXPECT_NEAR(2.0, getPrimal(u2), 1e-15);
...
TEST_F(TestConcatSurfaces, concatWithParams)
{
    ...
    EXPECT_NEAR(0.0, getPrimal(u1), 1e-15);
    EXPECT_NEAR(4.0, getPrimal(u2), 1e-15);
    EXPECT_NEAR(0.0, getPrimal(v1), 1e-15);
    EXPECT_NEAR(1.0, getPrimal(v2), 1e-15);
...
TEST(ApproxSurface, simple)
{
    ...
    EXPECT_EQ(0., getPrimal(surfApprox->UKnot(1)));
    EXPECT_EQ(0.5, getPrimal(surfApprox->UKnot(2)));
    EXPECT_EQ(1.0, getPrimal(surfApprox->UKnot(3)));

    EXPECT_EQ(0., getPrimal(surfApprox->VKnot(1)));
    EXPECT_EQ(0.25, getPrimal(surfApprox->VKnot(2)));
    EXPECT_EQ(0.375, getPrimal(surfApprox->VKnot(3)));
    EXPECT_EQ(0.5, getPrimal(surfApprox->VKnot(4)));
    EXPECT_EQ(0.625, getPrimal(surfApprox->VKnot(5)));
    EXPECT_EQ(0.75, getPrimal(surfApprox->VKnot(6)));
    EXPECT_EQ(1.0, getPrimal(surfApprox->VKnot(7)));
    ...
    for (auto u_val : u) {
        for (auto v_val : v) {
            ...
            EXPECT_NEAR(0., getPrimal(pntApprox.Distance(pntOrig)), 1e-13);
        }
    }
}
