 ...
 */
GEOML_API_EXPORT Shape create_cylinder(Standard_Real radius, Standard_Real height);
 ...
 */
GEOML_API_EXPORT Shape create_box(Standard_Real dx, Standard_Real dy, Standard_Real dz);
