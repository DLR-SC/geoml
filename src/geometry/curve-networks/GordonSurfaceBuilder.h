...
/**
 * @brief This class is basically a helper class for the geoml::InterpolateCurveNetwork algorithm.
 * 
 ...
 * For practical reasons, use geoml::InterpolateCurveNetwork.
 */
...
public:
    ...
    GEOML_EXPORT Handle(Geom_BSplineSurface) SurfaceProfiles();
    
    /// Returns the surface that interpolates the guides
    GEOML_EXPORT Handle(Geom_BSplineSurface) SurfaceGuides();
