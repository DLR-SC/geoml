...
TEST(Misc, WireGetPoint)
{
    ...
    ASSERT_NEAR(4.0, getPrimal(GetLength(wireBuilder.Wire())), 1e-7);
    ...
    ASSERT_NEAR(0.0, getPrimal(p1_.Distance(p1)), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p2_.Distance(p2)), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p3_.Distance(p3)), 1e-7);
    ...
    ASSERT_NEAR(0.0 , getPrimal(ProjectPointOnWire(wireBuilder.Wire(), p1_)), 1e-7);
    ASSERT_NEAR(0.25, getPrimal(ProjectPointOnWire(wireBuilder.Wire(), p2_)), 1e-7);
    ASSERT_NEAR(1.0 , getPrimal(ProjectPointOnWire(wireBuilder.Wire(), p3_)), 1e-7);
}
...
TEST(Misc, GetPointOnCirc)
{
    ...
    ASSERT_NEAR(0.0, getPrimal(p1.Distance(WireGetPoint(wire,0.00))), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p2.Distance(WireGetPoint(wire,0.25))), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p3.Distance(WireGetPoint(wire,0.50))), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p4.Distance(WireGetPoint(wire,0.75))), 1e-7);
    ASSERT_NEAR(0.0, getPrimal(p5.Distance(WireGetPoint(wire,1.00))), 1e-7);
    ...
    ASSERT_NEAR(0.00, getPrimal(ProjectPointOnWire(wire, p1)), 1e-7);
    ASSERT_NEAR(0.25, getPrimal(ProjectPointOnWire(wire, p2)), 1e-7);
    ASSERT_NEAR(0.50, getPrimal(ProjectPointOnWire(wire, p3)), 1e-7);
    ASSERT_NEAR(0.75, getPrimal(ProjectPointOnWire(wire, p4)), 1e-7);
    ASSERT_NEAR(1.00, getPrimal(ProjectPointOnWire(wire, p5)), 1e-7);
}
