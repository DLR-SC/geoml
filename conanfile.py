...
class geomlConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.includedirs.append(os.path.join("include", "geoml", "geom_topo_conversions"))
        ...
        self.cpp_info.includedirs.append(os.path.join("include", "geoml", "transformations"))
        self.cpp_info.includedirs.append(os.path.join("include", "geoml", "utilities"))
