...
writeGeomEntityToStepFile(TopoDS::Edge(edgeMap(2)), "my_test_edgee.stp");
...
// first test, if conversion from Geom_Circle to Geom_BSplineCurve works:
Handle(Geom_BSplineCurve) cur = GeomConvert::CurveToBSplineCurve(my_circle_curve);
writeToStp(cur, "test_converted_circle.stp"); // works 
...
std::cout << "If it reached till here, then it worked!" << std::endl; // not yet ...
// write a step file of the surface to disk:
//writeGeomEntityToStepFile(my_test_circle_interp_surface, "free_circ_surface.stp"); 
*/

//////////////////////////////////////////////////////////////////////////////////////
////////// fuselage - rear surface
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////

// Now, I want to turn the previously defined cylinder (TopoDS_Shape) 
// into a Geom_BSplineSurface:
...
Handle(Geom_Surface) test_surface = BRep_Tool::Surface(face);

Handle(Geom_BSplineSurface)
  b_surf = GeomConvert::SurfaceToBSplineSurface(test_surface);

writeGeomEntityToStepFile(b_surf, "converted_b_spline_surface.stp");// das hat funktioniert.


Handle(Geom_BSplineSurface) api_test_surface =
	geoml::revolving_surface(profile_curve,
							 gp_Ax1(gp_Pnt(0., 0., 0.), gp_Dir(1., 0., 0.)), 
							 0.5);
writeGeomEntityToStepFile(api_test_surface, "api_test_surface.stp");
...
std::cout << "Ende der main-Funktion"<< fuser.Operation() << std::endl;
