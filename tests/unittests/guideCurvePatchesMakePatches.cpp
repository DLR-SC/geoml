...
TEST(guideCurvePatches, segment)
{
    ...
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/guideCurvePatch_segmentGuides.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/guideCurvePatch_segmentProfiles.brep", b));
...
TEST(guideCurvePatches, simpleWing)
{
    TopoDS_Shape guides, profiles;
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/guideCurvePatch_simpleWingGuides.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/guideCurvePatch_simpleWingProfiles.brep", b));
...
TEST(guideCurvePatches, nacelle)
{
    TopoDS_Shape guides, profiles;
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/guideCurvePatch_nacelleGuides.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/guideCurvePatch_nacelleProfiles.brep", b));
...
TEST(guideCurvePatches, nacelleClosedProfiles)
{
    ...
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/guideCurvePatch_nacelleGuides.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/guideCurvePatch_nacelleProfilesClosed.brep", b));
...
TEST(guideCurvePatches, nacelleInverted)
{
    TopoDS_Shape guides, profiles;
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/guideCurvePatch_nacelleGuidesInverted.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/guideCurvePatch_nacelleProfiles.brep", b));
...
TEST(guideCurvePatches, bugHeliFuselage)
{
    TopoDS_Shape guides, profiles;
    BRep_Builder b;
    ASSERT_TRUE(BRepTools::Read(guides, "TestData/bugs/145/Fuselage_guides.brep", b));
    ASSERT_TRUE(BRepTools::Read(profiles, "TestData/bugs/145/Fuselage_profiles.brep", b));
