...
* It will reside in geoml, until this Algorithm becomes part of
* OpenCASCADE.
*
...
void MakeLoops::Perform()
{
    ...
    // **********************************************************************
    NCollection_DataMap<TopoDS_Shape, geoml::Continuity> continuityMapProfiles;
    NCollection_DataMap<TopoDS_Shape, geoml::Continuity> continuityMapGuides;
    for (i = 1; i <= GridVertices.Extent(); i++) {
        ...
        geoml::Continuity continuityProfiles;
    ...
    while (true) {
        ...
        std::vector<geoml::Continuity> vertexContinuities;
        ...
        geoml::Continuity patchContinuity = *std::max_element(vertexContinuities.begin(), vertexContinuities.end());
...
const NCollection_DataMap<TopoDS_Shape, geoml::Continuity>& MakeLoops::Continuities() const
{
