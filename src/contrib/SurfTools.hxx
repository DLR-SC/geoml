...
//
    ...
    @return None
    */
    GEOML_EXPORT static  void UReparametrize(Handle(Geom_BSplineSurface)& theS,
    ...
    @return None
    */
    GEOML_EXPORT static  void VReparametrize(Handle(Geom_BSplineSurface)& theS,
    ...
    @return None
    */
    GEOML_EXPORT static  void USmoothing(Handle(Geom_BSplineSurface)& theS,
    ...
    @return None
    */
    GEOML_EXPORT static  void VSmoothing(Handle(Geom_BSplineSurface)& theS,
                                        const Standard_Integer theCont,const Standard_Real theTol,
                                        const Standard_Boolean theInsertKnots = Standard_True) ;
    ...
    */
    GEOML_EXPORT static  Standard_Integer 
    ...
    */
    ...
    @return 0 if the concatenation has been done successfully
    */
    GEOML_EXPORT static Standard_Integer ConcatenateSurfaces(
