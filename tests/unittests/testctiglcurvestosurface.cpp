...
TEST(CurvesToSurface, testSkinnedBSplineSurface)
{
    /*
    ...
    CurvesToSurface skinner(splines_vector);
...
TEST(SplineAlgorithms, curvesToSurfaceContinuous)
{
...
TEST(BSplineAlgorithms, curvesToSurfaceBug)
{
    ...
    geoml::CurvesToSurface surfaceSkinner(profileCurves);
