...
//
     ...
     */
    GEOML_EXPORT MakePatches(const TopoDS_Shape& theGuides, const TopoDS_Shape& theProfiles);
     ...
     * compound consisting of profile (section) edges or wires
     */
    GEOML_EXPORT   void Init(const TopoDS_Shape& theGuides, const TopoDS_Shape& theProfiles) ;
     ...
     */
    GEOML_EXPORT   void Perform(const Standard_Real theTolConf,
    ...
    GEOML_EXPORT  const TopoDS_Shape& Patches() const;
     ...
     * GeomFill_CoonsC2Style
     */
    GEOML_EXPORT static  Handle(Geom_BSplineSurface)
    ...
    GEOML_EXPORT MakePatchesStatus GetStatus() const;
